...
#region SHOWJOURNAL
func show_journal():
	print("JournalMenu: show_journal() called")
	self.visible = true
...
# PRELOADS
var leaf_scene = preload("res://Objects/Leaf/Leaf.tscn")
#endregion VARIABLES
...
func _on_close_button_pressed() -> void:  # Emits on Close Button pressed
	print("JournalMenu: _on_close_button_pressed(): Exiting. Emitting close_journal")
	close_journal.emit()
